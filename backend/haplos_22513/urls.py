"""haplos_22513 URL Configuration
...
admin.site.site_header = "Haplos"
admin.site.site_title = "Haplos Admin Portal"
admin.site.index_title = "Haplos Admin"

# swagger
api_info = openapi.Info(
    title="Haplos API",
    default_version="v1",
    description="API documentation for Haplos App",
)
